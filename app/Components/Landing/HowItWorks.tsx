  ...
  return (
    <>
      ...
      <section
        ...
        className="block lg:hidden relative w-full overflow-hidden bg-black py-16 sm:py-24"
      >
        <div className="max-w-lg mx-auto px-5 sm:px-6">
          ...
          <div className="w-full max-w-md mx-auto space-y-4 sm:space-y-5">
            ...
            {steps.map((step, i) => (
              <div
                key={step.number}
                className="group z-50 relative flex gap-4 sm:gap-5 items-start p-3 sm:p-4 rounded-xl transition-colors duration-300 hover:bg-white/[0.04]"
              >
                {/* Step number */}
                <div
